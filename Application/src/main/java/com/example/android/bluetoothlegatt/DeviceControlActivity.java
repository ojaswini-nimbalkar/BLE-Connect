...
//                ExpandableListAdapter data = expandableListView.getExpandableListAdapter();
//                String uuidService  = ((HashMap<String, String>)data.getGroup(i)).get(LIST_UUID);
//                if( uuidService.equals(SampleGattAttributes.HEART_SERVICE)
//                    ||uuidService.equals(SampleGattAttributes.UUID_GATT_SERVICE)){
//                    requestId_Sec(uuidService);
//                }
//                return false;
//            }
//        });
        ...
        mUUID = findViewById(R.id.txtUUID);
    ...
    private void writeCharacteristic(){
        ...
        String name = SampleGattAttributes.lookup(mWriteCharacteristic.getUuid().toString(), "Unknown Characteristic");
        mUUID.setText(name);
...
//                R.layout.item_characteristic,
//                new String[] {LIST_NAME, LIST_UUID},
//                new int[] { R.id.char_name, R.id.char_id }
                android.R.layout.simple_expandable_list_item_2,
                new String[] {LIST_NAME, LIST_UUID},
                new int[] { android.R.id.text1, android.R.id.text2 }
        );
