...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_CHARACTERISTIC =
            UUID.fromString(SampleGattAttributes.GATT_CHARACTERISTIC);
       ...
       // Log.d(TAG, "decodeMessage:" + message);
        ...
        for (String item : arrOfStr) {
            if (item.length() >= 4) {
                ...
                if(count>=1 && count<=3) {
                    msg.append("Pressure sensor " + count + ": " + ret + " psi"+"\n");
                }
                else if(count == 4)
                {
                    msg.append("Temperature sensor " + count + ": " + ret + " *C"+"\n");
                }
                else
                    msg.append("value" + count + ": " + ret + " (arbitrary)" + "\n");
            }
            count++;
        }
        return msg.toString();
    ...
    private void broadcastUpdate(final String action,
        ...
        //if (UUID_CHARACTERISTIC.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 3) {
                ...
                //D4 C6 62 41
                //41 62 C6 D4  this is correct
                //14 26 6C 4D  this is incorrect
    ...
    public boolean onUnbind(Intent intent) {
        ...
        // such that resources are cleaned up properly.  In this particular tony, close() is
